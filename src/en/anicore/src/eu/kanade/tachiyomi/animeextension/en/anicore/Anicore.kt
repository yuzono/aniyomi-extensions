...
@Suppress("unused")
class Anicore : AniListAnimeHttpSource(), ConfigurableAnimeSource {
    override val name = "Anicore"
        ...
        val extras = episodeUrl.queryParameter("extras")
            ?.let {
                try {
                    ...
                    Log.e("Anicore", "Error decoding base64", e)
                    return emptyList()
                }
            }
            ?.let {
                try {
                    ...
                    Log.e("Anicore", "Error parsing JSON extras", e)
                    emptyList()
                }
            }
            ?: emptyList()
        ...
        val videos = extras.parallelFlatMap { extra ->
            ...
            languages.parallelFlatMap { language ->
                ...
                try {
                    ...
                    Log.e("Anicore", "VideoList $url SocketTimeoutException", e)
                    timeouts++
                    emptyList()
                } catch (e: IOException) {
                    Log.e("Anicore", "VideoList $url IOException", e)
                    emptyList()
                } catch (e: Exception) {
                    Log.e("Anicore", "VideoList $url Exception", e)
                    emptyList()
                }
            }
        }
    ...
    private fun getVideos(extra: EpisodeExtra, language: String, request: Request): List<Video> {
        ...
        try {
            ...
            Log.i("Anicore", "${extra.source} $language -> $sourcesString")
            ...
            Log.e("Anicore", "processEpisodeData Error (\"${extra.source} - $language\"): $e")
            return emptyList()
        }
    }
    ...
    private fun processEpisodeData(episodeData: EpisodeData): List<Video> {
        ...
        try {
            ...
            Log.e("Anicore", "processEpisodeData extractFromHls Error (\"$serverName - $typeName\"): $e")
        }
    ...
    private fun fetchHeaders() {
        val internalFetchHeaders = internalFetchHeaders@{
            ...
            if (timeout > currentTimestamp) {
                Log.i("Anicore", "Skipping header update. $timeout > $currentTimestamp (${timeout - currentTimestamp}).")
            ...
            try {
                ...
                Log.i("Anicore", "Fetched headers($preferredDomain): $domainHeaders")
            } catch (e: Exception) {
                Log.e("Anicore", "Failed to fetch new headers: \"e\"")
                return@internalFetchHeaders
            }
    ...
    private fun getHeaderValue(serverHost: String, key: String): String {
        ...
        try {
            ...
            Log.e("Anicore", "getHeaderValue error. $e. (s:${domainsHeaders.size}, l:$lastHeaderFetch)")
            throw e
        }
    }
